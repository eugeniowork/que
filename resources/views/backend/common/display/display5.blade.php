...
@section('title', trans('app.display_5'))
...
<div class="panel panel-primary">
    ...
    <div class="panel-heading">
        <div class="row">
            <div class="col-sm-12">
                <h3>{{ trans('OVERALL TOKEN') }} 
<button class="pull-right btn btn-sm btn-primary" onclick="goFullscreen('fullscreen'); return false"><i class="fa fa-arrows-alt" aria-hidden="true"></i></button></h3>
