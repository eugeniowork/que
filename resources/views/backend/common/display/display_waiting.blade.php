...
@section('title', "Display 1 - Waiting")
...
<div class="panel panel-primary">
    <div class="panel-body" id="fullscreen" style="color:{{ (!empty($setting->color)?$setting->color:'#ffffff') }}">
        ...
        <div class="panel-heading">
	        <div class="row">
	            <div class="col-sm-12">
	                <h3 style="font-size: 50px">WAITING LINE<button class="pull-right btn btn-sm btn-primary" onclick="goFullscreen('fullscreen'); return false"><i class="fa fa-arrows-alt" aria-hidden="true"></i></button></h3> 
